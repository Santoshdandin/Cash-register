...
const cashReturn = document.querySelector("#cash-return")
...
checkButton.addEventListener("click", function checktoreturn() {
       toBePaid = cashGiven.value - billAmount.value;

       cashReturn.innerText = toBePaid
